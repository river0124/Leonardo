...
try:
    ...
    post_to_slack("✅ 52주 신고가 리스트 업데이트 완료", config_path="/Users/hyungseoklee/Documents/Leonardo/backend/cache/settings.json")

except Exception as e:
    post_to_slack(f"❌ 52주 신고가 실패: {e}", config_path="/Users/hyungseoklee/Documents/Leonardo/backend/cache/settings.json")
    raise